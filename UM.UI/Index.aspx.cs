    ...
    public partial class Index : System.Web.UI.Page
    {
        ...
        private void ShowArticleList()
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                DataSet dsArtTypeList = userReg.ShowArticleTypeList(TypeId);
                for (int j = 0; j < dsArtTypeList.Tables[0].Rows.Count; j++)
                {
                    int articleId = Convert.ToInt32(dsArtTypeList.Tables[0].Rows[j]["ArticleId"]);
                    title = dsArtTypeList.Tables[0].Rows[j]["Title"].ToString();
                    crDate = dsArtTypeList.Tables[0].Rows[j]["CreateDate"].ToString();
                    ...
                    summary = dsArtTypeList.Tables[0].Rows[j]["Summary"].ToString();
                    author = dsArtTypeList.Tables[0].Rows[j]["UserName"].ToString();
                    if (summary == "")
                    {
                        string contents = dsArtTypeList.Tables[0].Rows[j]["Contents"].ToString();
