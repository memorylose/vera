...
namespace UM.UI
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        //public string CrYearhtml = "";
        //public string CrMonthhtml = "";
        //public string CrDayhtml = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                RankListhtml += "<div class=\"l-read-name\"><a href=\"ArticleDetail.aspx?id=" + Convert.ToInt32(ds.Tables[0].Rows[i]["ArticleId"]) + "\">" + ds.Tables[0].Rows[i]["Title"].ToString() + "</a></div>";
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                string crYear = crDate.Substring(0, 4).ToString();
                string crMonth = crDate.Substring(5, 1).ToString();//我想日期格式是yyyy-mm-dd，这种在用户注册的时候能设置吗
                string crDay = crDate.Substring(7, 2).ToString();
